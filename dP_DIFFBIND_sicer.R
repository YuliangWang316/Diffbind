library(DiffBind)
tamoxifen <- dba(sampleSheet = "E:/CJJ202404166BCD19DPDNK27CUTTAG/SICER/Diffbind_CJJ202404166bcd19dpdnl27cuttag.csv")
tamoxifen <- dba.blacklist(tamoxifen, blacklist=DBA_BLACKLIST_MM10,cores = 20,greylist = FALSE)
